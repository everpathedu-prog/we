        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative w-full z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 text-left">
              ...
              <div 
                onClick={() => openModal()}
                className="relative w-full sm:w-fit max-w-md cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
            ...
            <div className="lg:col-span-5 relative">
              <div className="bg-white rounded-2xl shadow-2xl border border-border p-6 md:p-8 max-w-md mx-auto text-text-primary relative overflow-hidden">
                ...
                <a
                  href="https://wa.me/917339329264?text=Hi!%20I'm%20interested%20in%20Chettinad%20Institute%20of%20Technology%20B.Tech%20Admissions%202026.%20Please%20share%20more%20details."
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((test, idx) => (
              ...
              >
                <div>
                  {/* Rating Stars */}
                  <div className="flex gap-1 mb-4 text-[#FFB000]">
