...
import { SaveethaEnquiryForm } from "./SaveethaEnquiryForm";

export function SaveethaEnquiryModal() {
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="bg-navy px-6 py-5 text-white relative border-b border-white/5">
              <h3 className="text-xl md:text-2xl font-bold">Saveetha B.Tech Admission Enquiry 2026</h3>
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <SaveethaEnquiryForm initialCourseSlug={selectedCourse} onSuccess={closeModal} />
            </div>
          </motion.div>
        </div>
      )}
