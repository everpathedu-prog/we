...
import { ChettinadEnquiryForm } from "./ChettinadEnquiryForm";

export function ChettinadEnquiryModal() {
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="bg-navy px-6 py-5 text-white relative border-b border-white/5">
              <h3 className="text-xl md:text-2xl font-bold">CIT Admission Enquiry 2026</h3>
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <ChettinadEnquiryForm initialCourseSlug={selectedCourse} onSuccess={closeModal} />
            </div>
          </motion.div>
        </div>
      )}
