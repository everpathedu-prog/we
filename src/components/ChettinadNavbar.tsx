...
export function ChettinadNavbar() {
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center gap-2.5 group">
            <div className="bg-white px-3 py-1.5 rounded-lg flex items-center justify-center transition-transform duration-300 group-hover:scale-[1.02]">
              <Image
                src="/citlogo.png"
                alt="Chettinad Academy of Research and Education"
                width={150}
                height={45}
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                className="font-medium text-sm text-white/90 hover:text-gold-light transition-colors duration-200"
              >
                {link.name}
              </a>
            ))}
